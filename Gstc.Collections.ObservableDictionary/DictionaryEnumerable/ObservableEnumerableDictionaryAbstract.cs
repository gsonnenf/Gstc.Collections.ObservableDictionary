...
/// <summary>
/// The ObservableEnumerableDictionary serves an enumerable wrapper with <see cref="INotifyCollectionChanged"/> events for a <see cref="IObservableDictionary{TKey, TValue}"/>
...
/// <br/><br/>
/// Order is not guarenteed between iterations, because a dictionary does not have a a set order. The collection changed event is thus 
/// always called with NotifyCollectionChangedAction.Reset. Dispose may be called to unbind the enumerable from the ObservableDictionary 
/// when the enumberable is no longer needed.
/// </summary>
...
public abstract class ObservableEnumerableDictionaryAbstract<TKey, TValue, TOutput> :
