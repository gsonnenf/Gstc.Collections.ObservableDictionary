namespace Gstc.Collections.ObservableDictionary.ComponentModel {
    public delegate void NotifyDictionaryDictionaryChangedEventHandler<TKey, TValue>(object sender, IDictionaryChangedEventArgs<TKey, TValue> e);
    public delegate void NotifyDictionaryChangingEventHandler<TKey, TValue>(object sender, IDictionaryChangedEventArgs<TKey, TValue> e);
