...
namespace Gstc.Collections.ObservableDictionary.ComponentModel {
    ...
    public class NotifyDictionaryChangedEventArgsOLD {
        ...
        public NotifyDictionaryChangedEventArgsOLD(NotifyDictionaryChangedAction action) {
            if (action != NotifyDictionaryChangedAction.Reset) throw new ArgumentException(ErrorMessage.GetString(ErrorMessage.WrongActionForCtor, NotifyDictionaryChangedAction.Reset), nameof(action));
        ...
        public NotifyDictionaryChangedEventArgsOLD(NotifyDictionaryChangedAction action, object key, object changedItem) {
            ...
            else throw new ArgumentException(ErrorMessage.GetString(ErrorMessage.MustBeResetAddOrRemoveActionForCtor), "action");
        }
        ...
        public NotifyDictionaryChangedEventArgsOLD(NotifyDictionaryChangedAction action, IList<object> keys, IList<object> changedItems) {

            if (changedItems == null) throw new ArgumentNullException("changedItems");
            if (keys == null || keys.Count == 0) throw new ArgumentException(ErrorMessage.GetString(ErrorMessage.KeyMustNotBeNullOrZeroLength), "Keys");
        ...
        public NotifyDictionaryChangedEventArgsOLD(NotifyDictionaryChangedAction action, object key, object oldItem, object newItem) {
            if (action != NotifyDictionaryChangedAction.Replace) throw new ArgumentException(ErrorMessage.GetString(ErrorMessage.WrongActionForCtor, NotifyDictionaryChangedAction.Replace), "action");
        ...
        public NotifyDictionaryChangedEventArgsOLD(NotifyDictionaryChangedAction action, IList<object> keys, IList<object> newItems, IList<object> oldItems) {
            if (action != NotifyDictionaryChangedAction.Replace) throw new ArgumentException(ErrorMessage.GetString(ErrorMessage.WrongActionForCtor, NotifyDictionaryChangedAction.Replace), "action");
